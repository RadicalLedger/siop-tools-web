...
const create = ({
    ...
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
                ...
                const verificationMethod =
                    (_b =
                        (_a =
                            ...
                            ? void 0
                            : _a.verificationMethod) === null || _b === void 0
                        ? void 0
                        : _b[0];
                /* base58 to hex */
            ...
            return (
                ((_c = result === null || result === void 0 ? void 0 : result.items) === null ||
                _c === void 0
                    ? void 0
                    : _c[0]) || null
            );
...
const verify = ({
    ...
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (
            (_e =
                (_d = vc === null || vc === void 0 ? void 0 : vc.credentialSubject) === null ||
                _d === void 0
                    ? void 0
                    : _d.selectiveDisclosureMetaData) === null || _e === void 0
                ? void 0
                : _e.proof
        ) {
                ...
                const verificationMethod =
                    (_g =
                        (_f =
                            ...
                            ? void 0
                            : _f.verificationMethod) === null || _g === void 0
                        ? void 0
                        : _g[0];
                /* base58 to hex */
                ...
                const verificationMethod =
                    (_j =
                        (_h =
                            documentLoaderResult === null || documentLoaderResult === void 0
                                ? void 0
                                : documentLoaderResult.document) === null || _h === void 0
                            ? void 0
                            : _h.verificationMethod) === null || _j === void 0
                        ? void 0
                        : _j[0];
                /* base58 to hex */
                holderPublicKey = buffer_1.Buffer.from(
            ...
            const mask =
                ((_l =
                    (_k = vc === null || vc === void 0 ? void 0 : vc.credentialSubject) === null ||
                    _k === void 0
                        ? void 0
                        : _k.selectiveDisclosureMetaData) === null || _l === void 0
                    ? void 0
                    : _l.mask) || {};
            ...
            try {
                const verified = utils_1.default.signature.verify({
                    ...
                    signature:
                        (_o =
                            (_m = vc === null || vc === void 0 ? void 0 : vc.credentialSubject) ===
                                null || _m === void 0
                                ? void 0
                                : _m.selectiveDisclosureMetaData) === null || _o === void 0
                            ? void 0
                            : _o.proof,
