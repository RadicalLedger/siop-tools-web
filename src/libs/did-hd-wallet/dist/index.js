...
var Wallet = /** @class */ (function () {
        ...
        switch (type) {
            case Types.SEED: {
                try {
                    ...
                    this.masterNode = bip32_1.fromSeed(buffer_1.Buffer.from(value, 'hex'));
                    break;
                } catch (e) {
                    throw Error(e);
                }
            ...
            case Types.MNEMONIC: {
                ...
                try {
                    ...
                    this.masterNode = bip32_1.fromSeed(buffer_1.Buffer.from(seed, 'hex'));
                } catch (e) {
                    throw Error(e);
                }
                break;
            ...
            case Types.BASE58: {
                try {
                    this.mnemonic = undefined;
                    this.masterNode = bip32_1.fromBase58(value);
                } catch (e) {
                    throw Error(e);
                }
                break;
    ...
    Wallet.prototype.getMasterKeys = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var privateKey, chainCode, verificationKey, publicKey, did, address;
    ...
    Wallet.prototype.getChildKeys = function (path) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var childNode, privateKey, chainCode, verificationKey, publicKey, did, address, e_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        ...
                        privateKey =
                            (_a = childNode.privateKey) === null || _a === void 0
                                ...
                                : _a.toString('hex');
                        chainCode =
                            (_b = childNode.chainCode) === null || _b === void 0
                                ? void 0
                                : _b.toString('hex');
                        return [4 /*yield*/, createVerificationMethod(privateKey)];
                    case 1:
...
function getSeedFromMnemonic(mnemonic) {
    if (bip39_1.validateMnemonic(mnemonic)) {
        try {
            var seed = bip39_1.mnemonicToSeedSync(mnemonic).toString('hex');
            return seed;
        } catch (e) {
            throw Error(e);
        }
